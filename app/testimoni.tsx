...
export default function TestimoniSection() {
    ...
    return (
        <section id="testimoni" className="w-full min-h-screen bg-[#0B122A] py-24 flex flex-col items-center justify-center overflow-hidden select-none">
            {/* Title */}
            ...
            {/* Slider Container */}
            <div
                className="relative w-full max-w-6xl h-[450px] flex items-center justify-center cursor-grab active:cursor-grabbing"
            ...
            >
                {testimonials.map((testimoni, index) => {
                    ...
                    let opacity = 1; // Remove fade animation as requested
                    ...
                    return (
                        <div
                            ...
                            className={`absolute w-[320px] sm:w-[400px] p-8 rounded-3xl flex flex-col justify-center shadow-2xl transition-all duration-500 ease-out ${bgColor} ${isCenter ? 'cursor-default' : 'cursor-pointer'}`}
                            style={{
                        ...
                        >
                            <p className={`text-center text-sm sm:text-base font-semibold leading-relaxed mb-6 ${textColor}`}>
                                {testimoni.text}
                            </p>
            ...
            <div className="mt-20 flex flex-col sm:flex-row items-center justify-center gap-6 pb-20 relative z-20">
                ...
                >
                    <ChevronUp size={16} className="transform group-hover:-translate-y-1 transition-transform duration-300 text-teal-200" />
                ...
                >
                    <span className="lang-text">{t('btn_view_profile')}</span>
                </a>
            </div>
        </section>
    );
