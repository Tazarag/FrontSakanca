...
export default function ServicesSection() {
  ...
  if (error || !services) {
    return (
      <section className="min-h-screen flex items-center justify-center">
        <p className="text-red-400">Gagal memuat data layanan.</p>
      </section>
    );
  }
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        {sitesettings?.services_section_bg ? (
          <Image
            src={resolveImage(sitesettings.services_section_bg)}
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(28,100,255,0.28),transparent_40%),linear-gradient(180deg,#08112d_0%,#0c1947_55%,#040816_100%)]" />
        )}
            ...
            if (service.col === "left") {
              return (
                ...
                >
                    ...
                    {serviceLogo ? (
                      <div className="w-full h-full relative p-2 flex items-center justify-center">
                        <Image
                          ...
                          fill
                          className="object-contain p-4 rounded-3xl sm:rounded-4xl"
                        />
                      </div>
                    ) : (
                      <>
                        <div
                          className={`p-3 rounded-2xl bg-linear-to-br ${meta.color} text-white shadow-md transform group-hover:rotate-6 transition-transform duration-300`}
                        >
                  ...
                  <div
                    className={`flex flex-col gap-3 -ml-10 sm:-ml-12 z-0 grow ${isVisible ? "animate-slide-out-right [animation-fill-mode:both]" : "opacity-0"}`}
              ...
              return (
                ...
                >
                  <div
                    className={`flex flex-col gap-3 -mr-10 sm:-mr-12 z-0 grow text-right items-end ${isVisible ? "animate-slide-out-left [animation-fill-mode:both]" : "opacity-0"}`}
                    style={{ animationDelay: contentDelay }}
                  >
