    ...
    <div className="absolute inset-0 z-0 overflow-hidden bg-black">
      {prev !== null && (
        ...
        >
          <div
            ...
            style={{
              animation: `${slides[prev].zoomType === "in" ? "kenBurns" : "kenBurnsOut"} 5000ms linear forwards`,
            }}
          >
            <Image
              src={slides[prev].src}
      ...
      >
        <div
          className="absolute inset-0"
          style={{
            animation: `${slides[current].zoomType === "in" ? "kenBurns" : "kenBurnsOut"} 5000ms linear forwards`,
          }}
        >
          <Image
      ...
      <div className="absolute inset-0 bg-linear-to-b from-black/60 via-black/20 to-black/85 z-10" />
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex space-x-2 z-20">
        {slides.map((_, i) => (
          <button
            ...
            className={`h-1.5 rounded-full transition-all duration-300 cursor-pointer ${i === current ? "w-8 bg-white" : "w-1.5 bg-white/30 hover:bg-white/60"}`}
